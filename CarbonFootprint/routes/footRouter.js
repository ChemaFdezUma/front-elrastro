...
router.get('/huellaCarbonoCostoCamion/:idUsuario/:idProducto', async (req, res) => {
    axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasUsuario/' + req.params.idUsuario).then((respuesta) => {
        const latitudUsuario = respuesta.data.latitud;
        const longitudUsuario = respuesta.data.longitud;
        
        axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasProducto/' + req.params.idProducto).then((respuesta) => {

            const latitudProducto = respuesta.data.latitud;
            const longitudProducto = respuesta.data.longitud;
            axios.get('https://mi-repo-ten.vercel.app/mapa/distancia/' + latitudUsuario + '/' + longitudUsuario + '/' + latitudProducto + '/' + longitudProducto).then((respuesta) => {

                const distancia = respuesta.data.distance;
                axios.get('https://mi-repo-ten.vercel.app/productos/' + req.params.idProducto).then((respuesta) => {
                    const peso = respuesta.data.peso;
                    axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbono/' + distancia + '/' + peso + '/camion').then((respuesta) => {
                        if (respuesta.data.length !== 0 && respuesta.data.message !== "No se ha encontrado ningún producto con esos datos.") {
                            ...
                            axios(options)
                                .then((response) => {
                                    ...
                                    axios.post('https://mi-repo-ten.vercel.app/huellaC/', {
                                        distancia: distancia,
                                        peso: peso,
    ...
    axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasUsuario/' + req.params.idUsuario).then((respuesta) => {
        ...
        axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasProducto/' + req.params.idProducto).then((respuesta) => {
            ...
            axios.get('https://mi-repo-ten.vercel.app/mapa/distancia/' + latitudUsuario + '/' + longitudUsuario + '/' + latitudProducto + '/' + longitudProducto).then((respuesta) => {
                ...
                axios.get('https://mi-repo-ten.vercel.app/productos/' + req.params.idProducto).then((respuesta) => {
                    const peso = respuesta.data.peso;
                    axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbono/' + distancia + '/' + peso + '/avion').then((respuesta) => {
                        if (respuesta.data.length !== 0 && respuesta.data.message !== "No se ha encontrado ningún producto con esos datos.") {
                            res.json(respuesta.data.huella);
                        } else {
                            //Agregar a la bdd
    ...
    axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasUsuario/' + req.params.idUsuario).then((respuesta) => {
        ...
        axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasProducto/' + req.params.idProducto).then((respuesta) => {
            ...
            axios.get('https://mi-repo-ten.vercel.app/mapa/distancia/' + latitudUsuario + '/' + longitudUsuario + '/' + latitudProducto + '/' + longitudProducto).then((respuesta) => {
                ...
                axios.get('https://mi-repo-ten.vercel.app/productos/' + req.params.idProducto).then((respuesta) => {
                    const peso = respuesta.data.peso;
                    axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbono/' + distancia + '/' + peso + '/barco').then((respuesta) => {
                        if (respuesta.data.length !== 0 && respuesta.data.message !== "No se ha encontrado ningún producto con esos datos.") {
                            res.json(respuesta.data.huella);
                        } else {
                            //Agregar a la bdd
    ...
    axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasUsuario/' + req.params.idUsuario).then((respuesta) => {
        ...
        axios.get('https://mi-repo-ten.vercel.app/mapa/coordenadasProducto/' + req.params.idProducto).then((respuesta) => {
            ...
            axios.get('https://mi-repo-ten.vercel.app/mapa/distancia/' + latitudUsuario + '/' + longitudUsuario + '/' + latitudProducto + '/' + longitudProducto).then((respuesta) => {
                ...
                axios.get('https://mi-repo-ten.vercel.app/productos/' + req.params.idProducto).then((respuesta) => {
                    const peso = respuesta.data.peso;
                    axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbono/' + distancia + '/' + peso + '/tren').then((respuesta) => {
                        if (respuesta.data.length !== 0 && respuesta.data.message !== "No se ha encontrado ningún producto con esos datos.") {
                            res.json(respuesta.data.huella);
                        } else {
                            //Agregar a la bdd
...
router.get('/calcularHuella/:idUsuario/:idProducto/:transporte', async (req, res) => {
    ...
    if(transporte == "camion"){
        axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbonoCostoCamion/' + idUsuario + '/' + idProducto).then((respuesta) => {
        ...
        axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbonoCostoAvion/' + idUsuario + '/' + idProducto).then((respuesta) => {
            res.json(respuesta.data);
        }).catch((error) => {
            res.json({ message: error });
        })
    }else if(transporte == "barco"){
        axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbonoCostoBarco/' + idUsuario + '/' + idProducto).then((respuesta) => {
        ...
        axios.get('https://mi-repo-ten.vercel.app/huellaC/huellaCarbonoCostoTren/' + idUsuario + '/' + idProducto).then((respuesta) => {
            res.json(respuesta.data);
        }).catch((error) => {
            res.json({ message: error });
        })
